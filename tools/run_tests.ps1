...
$testScripts = @(
	...
	"test_quanzhen_double_hand_abilities.gd",
	...
	"test_nianhua_sanru_integration.gd",
	...
	"test_yusui_kungang_abilities.gd",
	"test_yusui_kungang_integration.gd",
	"test_hujia_chuncan_abilities.gd",
