...
complete action. The controller caps production at public depth one on
difficulty 0, depth two on difficulty 1, and depth three on difficulty 2.
Difficulty 3 and above do not add a maximum depth. Production also uses a hard
five-second base deadline; difficulty 10 doubles it to ten seconds. Node-limited
