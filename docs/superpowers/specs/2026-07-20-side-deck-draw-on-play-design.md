...
5. Apply a short scale/fade arrival animation, disabled by integration fast mode.
...
A manual portrait playtest will cover player draw, opponent concealed draw, testing-mode opponent draw, invalid drops after drawing, and repeated play of a drawn on-play card.
