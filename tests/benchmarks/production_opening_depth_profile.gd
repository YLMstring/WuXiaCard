...
func _record_depth_progress(progress: Dictionary) -> void:
	...
	_depth_snapshots.append({
		...
		"visited_children": int(progress.get("visited_children", 0)),
		"cutoff_first_child": int(progress.get("cutoff_first_child", 0)),
		"cutoff_second_child": int(progress.get("cutoff_second_child", 0)),
		"cutoff_third_fourth_child": int(progress.get("cutoff_third_fourth_child", 0)),
		"cutoff_fifth_eighth_child": int(progress.get("cutoff_fifth_eighth_child", 0)),
		"cutoff_ninth_or_later_child": int(progress.get("cutoff_ninth_or_later_child", 0)),
