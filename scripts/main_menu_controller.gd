...
const TITLE_BREATH_MIN_SCALE: Vector2 = Vector2(1, 1)
const TITLE_BREATH_MAX_SCALE: Vector2 = Vector2(1, 1)
const TITLE_BREATH_DURATION: float = 1.5
const TITLE_GLOW_MIN_STRENGTH: float = 0.1
const TITLE_GLOW_MAX_STRENGTH: float = 0.3
