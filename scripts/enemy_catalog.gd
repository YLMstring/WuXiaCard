...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"baishi_daoren", "name": "白石道人", "level": 7, "deck": [&"QiXinLuoChangKong2", &"TianChangZhang3", &"HenShanJianZhen2", &"JinZhenDuJie1", &"qianji_tingyu"]},
	{"id": &"fengsha_lingzhu", "name": "风沙令主", "level": 8, "deck": [&"TianChangZhang3", &"HenShanJianZhen2", &"JinZhenDuJie1", &"qianji_tingyu", &"hengsha_duanlu"]},
	{"id": &"canghai_haoke", "name": "沧海豪客", "level": 8, "deck": [&"HenShanJianZhen2", &"JinZhenDuJie1", &"qianji_tingyu", &"hengsha_duanlu", &"chilian_huifeng"]},
	{"id": &"qianji_xiansheng", "name": "千机先生", "level": 9, "deck": [&"JinZhenDuJie1", &"qianji_tingyu", &"hengsha_duanlu", &"chilian_huifeng", &"shahai_zhuri"]},
