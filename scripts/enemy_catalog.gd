...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"chisha_menzhu2", "name": "冲虚", "level": 12, "deck": [&"TiYunZong4", &"RaoZhiRouJian4", &"TaiJiSanHuan5", &"TaiJiDaKui5", &"ShenMen13Jian3"]},
	{"id": &"chisha_menzhu3", "name": "方证", "level": 12, "deck": [&"YiJJ5", &"QianShouRuLai5", &"BaoCanShouQue4", &"NianhuaWeiXiao4", &"JinGangBuHuai4"]},
	{"id": &"bailu_shanzhang", "name": "五岳掌门·岳不群", "level": 13, "deck": [&"SanQinFeng3", &"KuiHua4", &"KuiHua3", &"KuiHua2", &"ZiXiaGong4"]},
	{"id": &"bailu_shanzhang2", "name": "雪山飞狐·胡斐", "level": 13, "deck": [&"HuJiaDao1", &"HuJiaDao2", &"HuJiaDao3", &"ChunCanZhang3", &"TaiJiLuanHuan4"]},
