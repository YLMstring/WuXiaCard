...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"jiange_suzhu", "name": "剑阁宿主", "level": 11, "deck": [&"YiJianLuo9Yan1", &"TianZhuYunQi2", &"JianFaQinYin1", &"YanHuiZhuRong3", &"canghai_sandie"]},
	{"id": &"tingchao_zhuren", "name": "听潮主人", "level": 11, "deck": [&"TianZhuYunQi2", &"JianFaQinYin1", &"YanHuiZhuRong3", &"canghai_sandie", &"haitian_yizhang"]},
	{"id": &"chisha_menzhu", "name": "赤砂门主", "level": 12, "deck": [&"JianFaQinYin1", &"YanHuiZhuRong3", &"canghai_sandie", &"haitian_yizhang", &"zhujian_cangfeng"]},
	{"id": &"yanyu_louzhu", "name": "烟雨楼主", "level": 12, "deck": [&"YanHuiZhuRong3", &"canghai_sandie", &"haitian_yizhang", &"zhujian_cangfeng", &"luming_wenlu"]},
