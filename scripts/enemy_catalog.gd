...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"tingchao_zhuren", "name": "听潮主人", "level": 11, "deck": [&"TianZhuYunQi2", &"JianFaQinYin1", &"YanHuiZhuRong3", &"WanYueChaoZong1", &"haitian_yizhang"]},
	{"id": &"chisha_menzhu", "name": "赤砂门主", "level": 12, "deck": [&"JianFaQinYin1", &"YanHuiZhuRong3", &"WanYueChaoZong1", &"haitian_yizhang", &"zhujian_cangfeng"]},
	{"id": &"yanyu_louzhu", "name": "烟雨楼主", "level": 12, "deck": [&"YanHuiZhuRong3", &"WanYueChaoZong1", &"haitian_yizhang", &"zhujian_cangfeng", &"luming_wenlu"]},
	{"id": &"bailu_shanzhang", "name": "白鹿山长", "level": 13, "deck": [&"WanYueChaoZong1", &"haitian_yizhang", &"zhujian_cangfeng", &"luming_wenlu", &"jingwei_dingju"]},
