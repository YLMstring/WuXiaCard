...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"zhenyue_shi", "name": "镇岳使", "level": 10, "deck": [&"MianLiCangZhen2", &"YunWu13Shi2", &"YiJianLuo9Yan1", &"TianZhuYunQi2", &"dielang_tuizhou"]},
	{"id": &"wuying_ke", "name": "无影客", "level": 10, "deck": [&"YunWu13Shi2", &"YiJianLuo9Yan1", &"TianZhuYunQi2", &"dielang_tuizhou", &"huichao_tingjin"]},
	{"id": &"jiange_suzhu", "name": "剑阁宿主", "level": 11, "deck": [&"YiJianLuo9Yan1", &"TianZhuYunQi2", &"dielang_tuizhou", &"huichao_tingjin", &"canghai_sandie"]},
	{"id": &"tingchao_zhuren", "name": "听潮主人", "level": 11, "deck": [&"TianZhuYunQi2", &"dielang_tuizhou", &"huichao_tingjin", &"canghai_sandie", &"haitian_yizhang"]},
