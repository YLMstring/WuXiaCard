...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"jinling_kuaijian", "name": "金陵快剑", "level": 6, "deck": [&"LaiHeQinQuan1", &"TaiShan18Pan1", &"WuDaFuJian1", &"QiXinLuoChangKong2", &"TianChangZhang3"]},
	{"id": &"chilian_sanke", "name": "赤练散客", "level": 6, "deck": [&"TaiShan18Pan1", &"WuDaFuJian1", &"QiXinLuoChangKong2", &"TianChangZhang3", &"HenShanJianZhen2"]},
	{"id": &"xuanhuo_qishi", "name": "玄火骑士", "level": 7, "deck": [&"WuDaFuJian1", &"QiXinLuoChangKong2", &"TianChangZhang3", &"HenShanJianZhen2", &"JinZhenDuJie1"]},
	{"id": &"baishi_daoren", "name": "白石道人", "level": 7, "deck": [&"QiXinLuoChangKong2", &"TianChangZhang3", &"HenShanJianZhen2", &"JinZhenDuJie1", &"WanHuaJian1"]},
	{"id": &"fengsha_lingzhu", "name": "风沙令主", "level": 8, "deck": [&"TianChangZhang3", &"HenShanJianZhen2", &"JinZhenDuJie1", &"WanHuaJian1", &"MianLiCangZhen2"]},
	{"id": &"canghai_haoke", "name": "沧海豪客", "level": 8, "deck": [&"HenShanJianZhen2", &"JinZhenDuJie1", &"WanHuaJian1", &"MianLiCangZhen2", &"YunWu13Shi2"]},
	{"id": &"qianji_xiansheng", "name": "千机先生", "level": 9, "deck": [&"JinZhenDuJie1", &"WanHuaJian1", &"MianLiCangZhen2", &"YunWu13Shi2", &"YiJianLuo9Yan1"]},
	{"id": &"hanyue_nvxia", "name": "寒月女侠", "level": 9, "deck": [&"WanHuaJian1", &"MianLiCangZhen2", &"YunWu13Shi2", &"YiJianLuo9Yan1", &"TianZhuYunQi2"]},
	{"id": &"zhenyue_shi", "name": "镇岳使", "level": 10, "deck": [&"MianLiCangZhen2", &"YunWu13Shi2", &"YiJianLuo9Yan1", &"TianZhuYunQi2", &"JianFaQinYin1"]},
	{"id": &"wuying_ke", "name": "无影客", "level": 10, "deck": [&"YunWu13Shi2", &"YiJianLuo9Yan1", &"TianZhuYunQi2", &"JianFaQinYin1", &"YanHuiZhuRong3"]},
	{"id": &"jiange_suzhu", "name": "剑阁宿主", "level": 11, "deck": [&"YiJianLuo9Yan1", &"TianZhuYunQi2", &"JianFaQinYin1", &"YanHuiZhuRong3", &"WanYueChaoZong1"]},
	{"id": &"tingchao_zhuren", "name": "听潮主人", "level": 11, "deck": [&"TianZhuYunQi2", &"JianFaQinYin1", &"YanHuiZhuRong3", &"WanYueChaoZong1", &"DaSongYangZhang1"]},
	{"id": &"chisha_menzhu", "name": "赤砂门主", "level": 12, "deck": [&"JianFaQinYin1", &"YanHuiZhuRong3", &"WanYueChaoZong1", &"DaSongYangZhang1", &"YinYangZhang3"]},
	{"id": &"yanyu_louzhu", "name": "烟雨楼主", "level": 12, "deck": [&"YanHuiZhuRong3", &"WanYueChaoZong1", &"DaSongYangZhang1", &"YinYangZhang3", &"HanBinZhenQi3"]},
	{"id": &"bailu_shanzhang", "name": "白鹿山长", "level": 13, "deck": [&"WanYueChaoZong1", &"DaSongYangZhang1", &"YinYangZhang3", &"HanBinZhenQi3", &"TianWaiYuLong2"]},
	{"id": &"xuanyue_jianshou", "name": "玄岳剑首", "level": 13, "deck": [&"DaSongYangZhang1", &"YinYangZhang3", &"HanBinZhenQi3", &"TianWaiYuLong2", &"zhishang_shanhe"]},
	{"id": &"tianmen_yishi", "name": "天门遗世", "level": 14, "deck": [&"YinYangZhang3", &"HanBinZhenQi3", &"TianWaiYuLong2", &"zhishang_shanhe", &"gate_general"]},
	{"id": &"guhai_kuangdao", "name": "孤海狂刀", "level": 14, "deck": [&"HanBinZhenQi3", &"TianWaiYuLong2", &"zhishang_shanhe", &"gate_general", &"meng_huo"]},
	{"id": &"wulin_sanren", "name": "武林散人", "level": 15, "deck": [&"TianWaiYuLong2", &"zhishang_shanhe", &"gate_general", &"meng_huo", &"CangSongYingKe1"]},
