...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"beiling_shuangying", "name": "北岭双影", "level": 4, "deck": [&"fire_envoy", &"tiger_general", &"strategist", &"strategist", &"LaiHeQinQuan1"]},
	{"id": &"yanbo_yuke", "name": "烟波渔客", "level": 4, "deck": [&"tiger_general", &"strategist", &"strategist", &"LaiHeQinQuan2", &"huixue_liuguang"]},
	{"id": &"cangyan_hufa", "name": "苍岩护法", "level": 5, "deck": [&"strategist", &"strategist", &"LaiHeQinQuan3", &"huixue_liuguang", &"qiyao_lianfeng"]},
	{"id": &"tingyu_zhangshi", "name": "听雨掌事", "level": 5, "deck": [&"strategist", &"LaiHeQinQuan4", &"huixue_liuguang", &"qiyao_lianfeng", &"wanyue_guizong"]},
	{"id": &"jinling_kuaijian", "name": "金陵快剑", "level": 6, "deck": [&"LaiHeQinQuan5", &"huixue_liuguang", &"qiyao_lianfeng", &"wanyue_guizong", &"yuyan_tousuo"]},
