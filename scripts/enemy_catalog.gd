...
const _ENEMY_ROWS: Array[Dictionary] = [
	{"id": &"qingfeng_xuedi", "name": "清风学弟", "level": 1, "deck": [&"CangSongYingKe1", &"CangSongYingKe2", &"fire_envoy", &"tiger_general", &"strategist"]},
	{"id": &"dukou_xiaoke", "name": "渡口侠客", "level": 1, "deck": [&"CangSongYingKe2", &"CangSongYingKe3", &"CangSongYingKe4", &"YouFenLaiYi2", &"fa_zheng"]},
	{"id": &"tieshan_menren", "name": "铁山门人", "level": 2, "deck": [&"CangSongYingKe3", &"CangSongYingKe4", &"YouFenLaiYi2", &"fa_zheng", &"fire_envoy"]},
	{"id": &"qingzhu_daoke", "name": "青竹刀客", "level": 2, "deck": [&"CangSongYingKe4", &"YouFenLaiYi2", &"fa_zheng", &"fire_envoy", &"tiger_general"]},
	{"id": &"luoxia_jianji", "name": "落霞剑姬", "level": 3, "deck": [&"YouFenLaiYi2", &"fa_zheng", &"fire_envoy", &"tiger_general", &"strategist"]},
	{"id": &"heisha_xingzhe", "name": "黑砂行者", "level": 3, "deck": [&"fa_zheng", &"fire_envoy", &"tiger_general", &"strategist", &"strategist"]},
	{"id": &"beiling_shuangying", "name": "北岭双影", "level": 4, "deck": [&"fire_envoy", &"tiger_general", &"strategist", &"strategist", &"hanfeng_liezhen"]},
	{"id": &"yanbo_yuke", "name": "烟波渔客", "level": 4, "deck": [&"tiger_general", &"strategist", &"strategist", &"hanfeng_liezhen", &"huixue_liuguang"]},
	{"id": &"cangyan_hufa", "name": "苍岩护法", "level": 5, "deck": [&"strategist", &"strategist", &"hanfeng_liezhen", &"huixue_liuguang", &"qiyao_lianfeng"]},
	{"id": &"tingyu_zhangshi", "name": "听雨掌事", "level": 5, "deck": [&"strategist", &"hanfeng_liezhen", &"huixue_liuguang", &"qiyao_lianfeng", &"wanyue_guizong"]},
	{"id": &"jinling_kuaijian", "name": "金陵快剑", "level": 6, "deck": [&"hanfeng_liezhen", &"huixue_liuguang", &"qiyao_lianfeng", &"wanyue_guizong", &"yuyan_tousuo"]},
	{"id": &"chilian_sanke", "name": "赤练散客", "level": 6, "deck": [&"huixue_liuguang", &"qiyao_lianfeng", &"wanyue_guizong", &"yuyan_tousuo", &"wusuo_changqiao"]},
	{"id": &"xuanhuo_qishi", "name": "玄火骑士", "level": 7, "deck": [&"qiyao_lianfeng", &"wanyue_guizong", &"yuyan_tousuo", &"wusuo_changqiao", &"feixing_ruye"]},
	{"id": &"baishi_daoren", "name": "白石道人", "level": 7, "deck": [&"wanyue_guizong", &"yuyan_tousuo", &"wusuo_changqiao", &"feixing_ruye", &"qianji_tingyu"]},
