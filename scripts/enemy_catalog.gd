...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"canghai_haoke", "name": "沧海豪客", "level": 8, "deck": [&"HenShanJianZhen2", &"JinZhenDuJie1", &"WanHuaJian1", &"MianLiCangZhen2", &"chilian_huifeng"]},
	{"id": &"qianji_xiansheng", "name": "千机先生", "level": 9, "deck": [&"JinZhenDuJie1", &"WanHuaJian1", &"MianLiCangZhen2", &"chilian_huifeng", &"shahai_zhuri"]},
	{"id": &"hanyue_nvxia", "name": "寒月女侠", "level": 9, "deck": [&"WanHuaJian1", &"MianLiCangZhen2", &"chilian_huifeng", &"shahai_zhuri", &"damo_guzhan"]},
	{"id": &"zhenyue_shi", "name": "镇岳使", "level": 10, "deck": [&"MianLiCangZhen2", &"chilian_huifeng", &"shahai_zhuri", &"damo_guzhan", &"dielang_tuizhou"]},
