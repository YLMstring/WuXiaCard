...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"chisha_menzhu", "name": "赤砂门主", "level": 12, "deck": [&"JianFaQinYin1", &"YanHuiZhuRong3", &"WanYueChaoZong1", &"DaSongYangZhang1", &"zhujian_cangfeng"]},
	{"id": &"yanyu_louzhu", "name": "烟雨楼主", "level": 12, "deck": [&"YanHuiZhuRong3", &"WanYueChaoZong1", &"DaSongYangZhang1", &"zhujian_cangfeng", &"luming_wenlu"]},
	{"id": &"bailu_shanzhang", "name": "白鹿山长", "level": 13, "deck": [&"WanYueChaoZong1", &"DaSongYangZhang1", &"zhujian_cangfeng", &"luming_wenlu", &"jingwei_dingju"]},
	{"id": &"xuanyue_jianshou", "name": "玄岳剑首", "level": 13, "deck": [&"DaSongYangZhang1", &"zhujian_cangfeng", &"luming_wenlu", &"jingwei_dingju", &"zhishang_shanhe"]},
