...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"yanbo_yuke2", "name": "全真弟子", "level": 4, "deck": [&"TianGangBeiDou2", &"JinYanGong2", &"QiXinJuHui2", &"DingYangZhen2", &"TuNaShu2"]},
	...
	{"id": &"chilian_sanke2", "name": "孙不二", "level": 6, "deck": [&"TianGangBeiDou3", &"JinYanGong3", &"QiXinJuHui3", &"DingYangZhen2", &"TuNaShu2"]},
	...
	{"id": &"qianji_xiansheng", "name": "天门", "level": 8, "sect_id": &"TaiShanPai", "deck": [&"LaiHeQinQuan4", &"WuDaFuJian3", &"QiXinLuoChangKong4", &"TaiShan18Pan3", &"YuSuiKunGang3"]},
	{"id": &"fengsha_lingzhu", "name": "乐厚", "level": 9, "deck": [&"YinYangZhang4", &"DaSongYangZhang4", &"DaSongYangZhang4", &"DaSongYangZhang3", &"DaSongYangZhang3"]},
	{"id": &"baishi_daoren", "name": "五岳秘剑·岳灵珊", "level": 9, "deck": [&"YanHuiZhuRong4", &"TianZhuYunQi4", &"JinZhenDuJie4", &"WuDaFuJian3", &"WanYueChaoZong4"]},
	{"id": &"zhenyue_shi", "name": "君子剑·岳不群", "level": 9, "deck": [&"SanQinFeng3", &"CangSongYingKe4", &"YouFenLaiYi4", &"ZiXiaGong2", &"ZiXiaGong4"]},
	...
	{"id": &"wuying_ke2", "name": "空闻", "level": 10, "deck": [&"JinGangBuHuai4", &"BaoCanShouQue4", &"FuMoQuan4", &"LiJingRuLai4", &"RanMuDaoFa3"]},
	{"id": &"wuying_ke3", "name": "丘处机", "level": 10, "sect_id": &"QuanZhenPai", "deck": [&"TianGangBeiDou4", &"JinYanGong4", &"QiXinJuHui4", &"DingYangZhen4", &"TuNaShu3"]},
