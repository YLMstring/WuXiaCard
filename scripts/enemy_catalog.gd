...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"yanbo_yuke", "name": "烟波渔客", "level": 4, "deck": [&"tiger_general", &"strategist", &"strategist", &"LaiHeQinQuan1", &"TaiShan18Pan1"]},
	{"id": &"cangyan_hufa", "name": "苍岩护法", "level": 5, "deck": [&"strategist", &"strategist", &"LaiHeQinQuan1", &"TaiShan18Pan1", &"WuDaFuJian1"]},
	{"id": &"tingyu_zhangshi", "name": "听雨掌事", "level": 5, "deck": [&"strategist", &"LaiHeQinQuan1", &"TaiShan18Pan1", &"WuDaFuJian1", &"wanyue_guizong"]},
	{"id": &"jinling_kuaijian", "name": "金陵快剑", "level": 6, "deck": [&"LaiHeQinQuan1", &"TaiShan18Pan1", &"WuDaFuJian1", &"wanyue_guizong", &"yuyan_tousuo"]},
	{"id": &"chilian_sanke", "name": "赤练散客", "level": 6, "deck": [&"TaiShan18Pan1", &"WuDaFuJian1", &"wanyue_guizong", &"yuyan_tousuo", &"wusuo_changqiao"]},
	{"id": &"xuanhuo_qishi", "name": "玄火骑士", "level": 7, "deck": [&"WuDaFuJian1", &"wanyue_guizong", &"yuyan_tousuo", &"wusuo_changqiao", &"feixing_ruye"]},
