...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"hanyue_nvxia", "name": "莫大", "level": 9, "sect_id": &"tingchao_gu", "deck": [&"WanHuaJian1", &"MianLiCangZhen2", &"YunWu13Shi2", &"YiJianLuo9Yan1", &"TianZhuYunQi2"]},
	{"id": &"zhenyue_shi", "name": "君子剑·岳不群", "level": 10, "deck": [&"MianLiCangZhen2", &"YunWu13Shi2", &"YiJianLuo9Yan1", &"TianZhuYunQi2", &"JianFaQinYin1"]},
	{"id": &"wuying_ke", "name": "左冷禅", "level": 10, "sect_id": &"SongShanPai", "deck": [&"YunWu13Shi2", &"YiJianLuo9Yan1", &"TianZhuYunQi2", &"JianFaQinYin1", &"YanHuiZhuRong3"]},
