...
const _ENEMY_ROWS: Array[Dictionary] = [
	...
	{"id": &"chilian_sanke", "name": "赤练散客", "level": 6, "deck": [&"TaiShan18Pan1", &"WuDaFuJian1", &"QiXinLuoChangKong2", &"TianChangZhang3", &"wusuo_changqiao"]},
	{"id": &"xuanhuo_qishi", "name": "玄火骑士", "level": 7, "deck": [&"WuDaFuJian1", &"QiXinLuoChangKong2", &"TianChangZhang3", &"wusuo_changqiao", &"feixing_ruye"]},
	{"id": &"baishi_daoren", "name": "白石道人", "level": 7, "deck": [&"QiXinLuoChangKong2", &"TianChangZhang3", &"wusuo_changqiao", &"feixing_ruye", &"qianji_tingyu"]},
	{"id": &"fengsha_lingzhu", "name": "风沙令主", "level": 8, "deck": [&"TianChangZhang3", &"wusuo_changqiao", &"feixing_ruye", &"qianji_tingyu", &"hengsha_duanlu"]},
