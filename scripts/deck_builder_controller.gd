...
func _create_hand_slots(container: HBoxContainer) -> void:
	SelectionShell.create_hand_slots(container)
...
func _layout_scene() -> void:
	...
	var library_rect: Rect2 = layout["library_rect"]
	var library_position: Vector2 = library_rect.position
	var library_width: float = library_rect.size.x
	var library_height: float = library_rect.size.y
