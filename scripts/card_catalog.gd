...
const _CARD_DEFINITIONS: Dictionary = {
	...
	&"SanRuDiYu2": {
		...
		"tier": 6,
		"weapon": "指法",
		"description": "我被丢弃后，将我变成三入地狱并抽回手牌。进场后，在首两个相邻空位依次打出你弃牌堆最上方的两张牌。回合结束时，将我移除。我可以攻击直线上相隔一个空位，或相隔一个友方的敌方。",
		"flavor": "摩诃指的正宗招数，看似平凡无奇，但其中所蕴蓄的功力超凡入圣，修习这三捺时用功之苦，每捺一下，便如入了一次地狱一般，因此叫作“三入地狱”。",
		"powers": [2, 2, 4, 4],
		"abilities": [],
	},
	&"SanRuDiYu3": {
		...
		"tier": 6,
		"weapon": "指法",
		"description": "进场后，在首三个相邻空位依次打出你弃牌堆最上方的三张牌，如果相邻空位不足，在非相邻空位继续打出。回合结束时，将我移除。我可以攻击直线上相隔一个空位，或相隔一个友方的敌方。",
		"flavor": "摩诃指的正宗招数，看似平凡无奇，但其中所蕴蓄的功力超凡入圣，修习这三捺时用功之苦，每捺一下，便如入了一次地狱一般，因此叫作“三入地狱”。",
		"powers": [2, 2, 4, 4],
		"abilities": [],
	},
	...
	&"JinGangBuHuai4": {
		...
		"tier": 4,
		"weapon": "心法",
		"description": "友方翻面被阻止后，令其点数加一，然后发起攻击。我翻面前，丢弃最左侧的手牌，若如此做，阻止翻面，然后耗内力以抽回丢弃的牌。",
		"flavor": "少林派的护体神功，随心而起，布满全身，乃古今五大神功之一。",
		"powers": [6, 3, 6, 3],
		"starting_ki": 1,
		"abilities": [
