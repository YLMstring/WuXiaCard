...
const _CARD_DEFINITIONS: Dictionary = {
	...
	&"TaiJiSanHuan4": {
		...
		"tier": 4,
		"weapon": "剑法",
		"description": "相邻敌方的进场攻击不会选中我的友方，反而会选中我的敌方。",
	...
	&"TaiJiSanHuan5": {
		...
		"tier": 5,
		"weapon": "剑法",
		"description": "相邻敌方的进场攻击不会选中我的友方，反而会选中我的敌方。指定：选择一个空位，令你首张被移除的牌在此进场，抽一张牌。",
		"flavor": "太极剑法中的招式，神在剑先，绵绵不绝。",
		"powers": [5, 5, 5, 5],
		"starting_ki": 3,
		"abilities": [],
	...
	&"TaiJiDaKui5": {
		...
		"tier": 5,
		"weapon": "剑法",
		"description": "相邻敌方的进场攻击不会选中我的友方，反而会选中我的敌方。指定：选择场上的一张敌方牌，令其点数加一，然后所有敌方发起攻击，但攻击时会且只会选中我的敌方。",
