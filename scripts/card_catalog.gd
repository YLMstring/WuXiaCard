...
const _CARD_DEFINITIONS: Dictionary = {
	&"TianGangBeiDou2": {
		"id": &"TianGangBeiDou2",
		"glyph": "天罡北斗阵",
		"picture": "res://pics/LKT010_364.png",
		"sect": "全真派",
		"tier": 2,
		"weapon": "阵法",
		"description": "进场后，所有相邻友方发起攻击。",
	...
	&"TianGangBeiDou3": {
		...
		"tier": 3,
		"weapon": "阵法",
		"description": "进场后，所有相邻友方发起攻击。我翻面前，若我有相邻友方，耗内力以阻止翻面。",
		"flavor": "天罡北斗阵是全真教中最上乘的玄门功夫，王重阳当年曾为此阵花过无数心血。小则以之联手搏击，化而为大，可用于战阵。敌人来攻时，正面首当其冲者不用出力招架，却由身旁道侣侧击反攻，犹如一人身兼数人武功，确然威不可当。",
		"powers": [4, 3, 4, 3],
		"starting_ki": 1,
	...
	&"TianGangBeiDou4": {
		...
		"tier": 4,
		"weapon": "阵法",
		"description": "进场后，所有相邻友方发起攻击。我翻面前，若我有相邻友方，耗内力以阻止翻面。我翻面被阻止后，与首个相邻友方交换位置，然后重新进场。",
		"flavor": "天罡北斗阵是全真教中最上乘的玄门功夫，王重阳当年曾为此阵花过无数心血。小则以之联手搏击，化而为大，可用于战阵。敌人来攻时，正面首当其冲者不用出力招架，却由身旁道侣侧击反攻，犹如一人身兼数人武功，确然威不可当。",
		"powers": [4, 3, 4, 3],
		"starting_ki": 1,
	...
	&"TianGangBeiDou5": {
		...
		"tier": 5,
		"weapon": "阵法",
		"description": "进场后，所有其它友方发起攻击。我翻面前，若我有相邻友方，耗内力以阻止翻面。友方翻面被阻止后，令其与首个相邻友方交换位置，然后令其重新进场。",
		"flavor": "天罡北斗阵是全真教中最上乘的玄门功夫，王重阳当年曾为此阵花过无数心血。小则以之联手搏击，化而为大，可用于战阵。敌人来攻时，正面首当其冲者不用出力招架，却由身旁道侣侧击反攻，犹如一人身兼数人武功，确然威不可当。",
		"powers": [4, 3, 4, 3],
		"starting_ki": 1,
	...
	&"JinYanGong2": {
		"id": &"JinYanGong2",
		"glyph": "金雁功",
		"picture": "res://pics/LKT010_307.png",
		"sect": "全真派",
		"tier": 2,
		"weapon": "轻功",
	...
	&"JinYanGong3": {
		...
		"tier": 3,
		"weapon": "轻功",
		"description": "锁定：我翻面前，改为向首个相邻空格移动。进场后，抽一张牌。你抽牌时，令抽到的牌内力加一。",
		"flavor": "全真派极精深的轻身本领，以上乘内功为基，捷若猿猴，轻如飞鸟。",
		"powers": [3, 1, 1, 3],
		"abilities": [
	...
	&"JinYanGong4": {
		...
		"tier": 4,
		"weapon": "轻功",
		"description": "锁定：我翻面前，改为向首个相邻空格移动。进场后，抽一张牌。你抽牌时，令抽到的牌内力加一，并获得以下效果：我翻面前，若我有相邻友方，耗内力以阻止翻面。",
		"flavor": "全真派极精深的轻身本领，以上乘内功为基，捷若猿猴，轻如飞鸟。",
		"powers": [3, 1, 1, 3],
		"abilities": [
			TIYUNZONG_LOCKED_FLIP_MOVE,
	...
	&"ZuoYouHuBo5": {
		"id": &"ZuoYouHuBo5",
		"glyph": "双手互搏",
		"picture": "res://pics/LKT010_354.png",
		"sect": "江湖",
		"tier": 5,
		"weapon": "心法",
	...
	&"QiXinJuHui1": {
		"id": &"QiXinJuHui1",
		"glyph": "七星聚会",
		"picture": "res://pics/LKT010_347.png",
		"sect": "全真派",
		"tier": 1,
		"weapon": "阵法",
	...
	&"QiXinJuHui2": {
		...
		"tier": 2,
		"weapon": "阵法",
		"description": "我翻面前，若我有相邻友方，耗内力以阻止翻面。友方在相邻进场时，令其内力加一，并获得以下效果：我翻面前，若我有相邻友方，耗内力以阻止翻面。",
		"flavor": "丘处机等人从天罡北斗阵法中演化出的并力攻敌法门，每一招之出，都将数人劲力集于一点。",
		"powers": [3, 7, 3, 7],
		"starting_ki": 1,
	...
	&"QiXinJuHui3": {
		...
		"tier": 3,
		"weapon": "阵法",
		"description": "我翻面前，若我有相邻友方，耗内力以阻止翻面。其它友方在任意友方相邻进场时，令其内力加一，并获得以下效果：我翻面前，若我有相邻友方，耗内力以阻止翻面。",
		"flavor": "丘处机等人从天罡北斗阵法中演化出的并力攻敌法门，每一招之出，都将数人劲力集于一点。",
		"powers": [3, 7, 3, 7],
		"starting_ki": 1,
	...
	&"QiXinJuHui4": {
		...
		"tier": 4,
		"weapon": "阵法",
		"description": "锁定：我攻击时，防御者的点数视为其最小一侧的点数。我翻面前，若我有相邻友方，耗内力以阻止翻面。其它友方在任意友方相邻进场时，令其内力加一，并获得以下效果：我翻面前，若我有相邻友方，耗内力以阻止翻面。",
		"flavor": "丘处机等人从天罡北斗阵法中演化出的并力攻敌法门，每一招之出，都将数人劲力集于一点。",
		"powers": [3, 7, 3, 7],
		"starting_ki": 1,
	...
	&"CangSongYingKe2": {
		...
		"tier": 2,
		"weapon": "剑法",
		"description": "敌方进场后，若在我的攻击范围内，我对其发起攻击。",
		"flavor": "华山剑法的绝招。华山上有数株古松，枝叶向下伸展，有如张臂欢迎上山的游客一般，称为“迎客松”。这招“苍松迎客”，便是从这几株古松的形状上变化而出。",
		"powers": [3, 8, 8, 2],
	...
	&"CangSongYingKe3": {
		...
		"tier": 3,
		"weapon": "剑法",
		"description": "敌方进场后，若在我的攻击范围内，我对其发起攻击。我翻面前，耗内力以获取一张我的复制。",
		"flavor": "华山剑法的绝招。华山上有数株古松，枝叶向下伸展，有如张臂欢迎上山的游客一般，称为“迎客松”。这招“苍松迎客”，便是从这几株古松的形状上变化而出。",
		"powers": [3, 8, 8, 2],
		"abilities": [QIXIN_SUMMON_REACTION,
			{
	...
	&"LiJingRuLai3": {
		"id": &"LiJingRuLai3",
		"glyph": "礼敬如来",
		"picture": "res://pics/LKT010_032.png",
		"sect": "少林派",
		"tier": 3,
		"weapon": "拳法",
	...
	&"FuMoQuan3": {
		"id": &"FuMoQuan3",
		"glyph": "金刚伏魔圈",
		"picture": "res://pics/LKT010_332.png",
		"sect": "少林派",
		"tier": 3,
		"weapon": "阵法",
		"description": "友方移动前，令其点数减一。回合结束时，若你手牌为空，所有友方获得以下效果：敌方进场时，若在我的攻击范围内，我对其发起攻击。",
	...
	&"FuMoQuan4": {
		...
		"tier": 4,
		"weapon": "阵法",
		"description": "友方移动前，令其点数减一。回合结束时，若你手牌为空，所有友方获得以下效果：敌方进场时，若在我的攻击范围内，我对其发起攻击。锁定：我可以攻击直线上相隔一个空位，或相隔一个敌方的敌方。",
		"flavor": "金刚伏魔圈乃佛力伏魔的精妙大法，以《金刚经》为最高旨义，最后要达“无我相、无人相、无众生相、无寿者相”的境界，于人我之分、生死之别，尽皆视作空幻。",
		"powers": [8, 7, 2, 7],
	...
	&"NianhuaWeiXiao3": {
		"id": &"NianhuaWeiXiao3",
		"glyph": "拈花微笑",
		"picture": "res://pics/LKT010_093.png",
		"sect": "少林派",
		"tier": 3,
		"weapon": "指法",
	...
	&"YiKongDaoDi4": {
		"id": &"YiKongDaoDi4",
		"glyph": "一空到底",
		"picture": "res://pics/LKT010_453.png",
		"sect": "少林派",
		"tier": 4,
		"weapon": "掌法",
	...
	&"RanMuDaoFa2": {
		"id": &"RanMuDaoFa2",
		"glyph": "燃木刀法",
		"picture": "res://pics/LKT010_111.png",
		"sect": "少林派",
		"tier": 2,
		"weapon": "刀法",
		"description": "锁定，指定：选择一张手牌并丢弃，所有手牌点数加一，然后额外出一张牌。",
	...
	&"RanMuDaoFa3": {
		...
		"tier": 3,
		"weapon": "刀法",
		"description": "我攻击后，所有友方点数加一。锁定，指定：选择一张手牌并丢弃，所有手牌点数加一，然后额外出一张牌。",
		"flavor": "燃木刀法练成之后，在一根干木旁快劈九九八十一刀，刀刃不能损伤木材丝毫，刀上所发热力，却要将木材点燃生火。虽是单刀刀法，亦能以手掌作戒刀，狠砍狠斫。",
		"powers": [5, 7, 7, 5],
		"starting_ki": 1,
	...
	&"WuXiangJieZhi3": {
		"id": &"WuXiangJieZhi3",
		"glyph": "无相劫指",
		"picture": "res://pics/LKT010_146.png",
		"sect": "少林派",
		"tier": 3,
		"weapon": "指法",
	...
	&"SanRuDiYu1": {
		"id": &"SanRuDiYu1",
		"glyph": "一入地狱",
		"picture": "res://pics/LKT010_106.png",
		"sect": "少林派",
		"tier": 3,
		"weapon": "指法",
	...
	&"JinGangBuHuai4": {
		...
		"tier": 4,
		"weapon": "心法",
		"description": "友方翻面被阻止后，令其点数加一，然后发起攻击。我翻面前，丢弃最左侧的手牌，若如此做，阻止翻面，然后耗内力以获得一张被丢弃牌的复制。",
		"flavor": "少林派的护体神功，随心而起，布满全身，乃古今五大神功之一。",
		"powers": [6, 3, 6, 3],
		"starting_ki": 1,
		"abilities": [
	...
	&"QianShouRuLai5": {
		"id": &"QianShouRuLai5",
		"glyph": "千手如来掌",
		"picture": "res://pics/LKT010_436.png",
		"sect": "少林派",
		"tier": 5,
		"weapon": "掌法",
		"description": "场上有点数的非术数牌被移除后，在原位生成我的完美复制。我翻面前，丢弃最左侧的手牌，若如此做，阻止翻面，然后耗内力以获得一张被丢弃牌的完美复制。",
	...
	&"YiJJ4": {
		...
		"flavor": "易筋经的功夫圜一身之脉络，系五脏之精神，周而不散，行而不断，气自内生，血从外润。练成此经后，心动而力发，一攒一放，自然而施，不觉其出而自出，如潮之涨，似雷之发。练那易筋经，便如一叶小舟于大海巨涛之中，怒浪澎湃之际，小舟自然抛高伏低，何尝用力？若要用力，又那有力道可用？又从何处用起？",
		"powers": [3, 3, 3, 3],
	...
	&"XiXinDaFa4": {
		"id": &"XiXinDaFa4",
		"glyph": "吸星大法",
		"picture": "res://pics/LKT010_387.png",
		"sect": "明教",
		"tier": 4,
		"weapon": "心法",
		"description": "锁定：我攻击时不分敌我。进场后，使我翻面，并获得以下效果：回合开始时，向你最左侧的手牌以及所有相邻友方吸取一点内力，若没有内力可以吸取，改为吸取点数，判断是否能被攻击时，所有点数视为零，我翻面后，手牌和场上的其它友方增加等同于我内力值的内力，然后我发起攻击。",
	...
	&"XiXinDaFa5": {
		...
		"tier": 5,
		"weapon": "心法",
		"description": "进场后，使我翻面，并获得以下效果：回合开始时，向你最左侧的手牌以及所有相邻友方吸取一点内力，若没有内力可以吸取，改为吸取点数，判断是否能被攻击时，所有点数视为零，我翻面后，手牌和场上的其它友方增加等同于我内力值的内力，然后我发起攻击。",
	...
	&"TaiJiSanHuan4": {
		...
		"tier": 4,
		"weapon": "剑法",
		"description": "在相邻进场且保持相邻的敌方进场攻击不会选中我的友方，反而会选中我的敌方，敌方攻击后，我失去此效果。",
	...
	&"TaiJiSanHuan5": {
		...
		"tier": 5,
		"weapon": "剑法",
		"description": "在相邻进场且保持相邻的敌方进场攻击不会选中我的友方，反而会选中我的敌方，敌方攻击后，我失去此效果。指定：选择一个空位，令你首张被移除的，有点数的牌在此进场，抽一张牌。",
		"flavor": "太极剑法中的招式，神在剑先，绵绵不绝。",
		"powers": [5, 5, 5, 5],
		"starting_ki": 3,
		"abilities": [
	...
	&"TaiJiDaKui5": {
		...
		"tier": 5,
		"weapon": "剑法",
		"description": "在相邻进场且保持相邻的敌方进场攻击不会选中我的友方，反而会选中我的敌方，敌方攻击后，我失去此效果。指定：选择场上的一张敌方牌，令其点数加一，然后所有敌方发起攻击，但攻击时会且只会选中我的敌方。",
	...
	&"HuZhuaJueHuSHou1": {
		"id": &"HuZhuaJueHuSHou1",
		"glyph": "虎爪绝户手",
		"picture": "res://pics/LKT010_170.png",
		"sect": "武当派",
		"tier": 1,
		"weapon": "指法",
		"description": "",
	...
	&"LaiHeQinQuan5": {
		...
		"tier": 5,
		"weapon": "重剑",
		"description": "指定：选择对手的一张手牌，使其永久失去效果，若其已被揭示，额外出一张牌。我翻面前，阻止翻面，敌方翻面后或回合开始时，失去此效果。若你携带我进入对局，那么你行动时，可以按下左侧回放按钮进行悔棋。（无论我在哪里）",
	...
	&"QiXinLuoChangKong2": {
		...
		"tier": 2,
		"weapon": "重剑",
		"description": "锁定：场上没有其它友方时无法攻击。锁定：我攻击时，防御者的点数视为其最小一侧的点数。",
	...
	&"QiXinLuoChangKong3": {
		...
		"tier": 3,
		"weapon": "重剑",
		"description": "锁定：场上没有其它友方时无法攻击。锁定：我攻击时，防御者的点数视为其最小一侧的点数。敌方进场后，若在我的攻击范围内，我对其发起攻击。",
		"flavor": "泰山派剑法的精要所在。单只这一剑，便罩住对方胸口的膻中、神藏、灵墟、神封、步廊、幽门、通谷七处大穴，不论闪向何处，总有一穴会让剑尖刺中。须得轻功高强，立即倒纵出丈许之外，方可避过。",
		"powers": [6, 6, 5, 6],
		"abilities": [
	...
	&"QiXinLuoChangKong4": {
		...
		"tier": 4,
		"weapon": "重剑",
		"description": "锁定：场上没有其它友方时无法攻击。锁定：我攻击时，防御者的点数视为其最小一侧的点数。敌方进场后，若在我的攻击范围内，我对其发起攻击。我翻面前，阻止翻面，敌方翻面后或回合开始时，失去此效果。",
		"flavor": "泰山派剑法的精要所在。单只这一剑，便罩住对方胸口的膻中、神藏、灵墟、神封、步廊、幽门、通谷七处大穴，不论闪向何处，总有一穴会让剑尖刺中。须得轻功高强，立即倒纵出丈许之外，方可避过。",
		"powers": [7, 6, 5, 6],
		"abilities": [
			QIXIN_RETAINED_ATTACK_MODIFIERS,
	...
	&"JianFaQinYin2": {
		...
		"tier": 2,
		"weapon": "轻剑",
		"description": "进场后，抽一张牌，若与直线上的敌方相距一个空位，移动至该空位。指定：移动至一个相邻空格，然后额外出一张牌。",
		"flavor": "莫大先生的绝技，所谓“琴中藏剑，剑发琴音”，手中短剑嗡嗡作响，犹如灵蛇颤动不绝，将对手裹在剑光之中。",
		"powers": [4, 7, 6, 5],
		"starting_ki": 1,
	...
	&"JianFaQinYin3": {
		...
		"tier": 3,
		"weapon": "轻剑",
		"description": "进场后，抽一张牌，若与直线上的敌方相距一个空位，移动至该空位。我移动后，所有相邻敌方失去效果，直到当前回合结束。指定：移动至一个相邻空格，然后额外出一张牌。",
		"flavor": "莫大先生的绝技，所谓“琴中藏剑，剑发琴音”，手中短剑嗡嗡作响，犹如灵蛇颤动不绝，将对手裹在剑光之中。",
		"powers": [4, 7, 6, 5],
		"starting_ki": 1,
		"abilities": [
	...
	&"YinYangZhang3": {
		...
		"tier": 3,
		"weapon": "掌法",
		"description": "进场时，将我移除，抽两张掌法牌，所有友方掌法获得以下效果：【我可以攻击直线上相隔一个空位，或相隔一个友方的敌方】，然后发起攻击。",
		"flavor": "孝感乐厚的成名功夫，双掌掌力不同，一阴一阳，阳掌先出，阴力却先行着体。",
		"powers": [-1, -1, -1, -1],
	...
	&"YinYangZhang4": {
		...
		"tier": 4,
		"weapon": "掌法",
		"description": "进场时，将我移除，抽两张掌法牌，所有友方掌法获得以下效果：【我可以攻击直线上相隔一个空位，或相隔一个友方的敌方。友方点数增加后，我发起攻击】，然后发起攻击。",
		"flavor": "孝感乐厚的成名功夫，双掌掌力不同，一阴一阳，阳掌先出，阴力却先行着体。",
		"powers": [-1, -1, -1, -1],
	...
	&"HanBinZhenQi3": {
		...
		"tier": 3,
		"weapon": "心法",
		"description": "指定：选择对手的一张手牌，使其点数减四并揭示。我翻面后：获得以下效果：回合结束时，我和所有手牌点数减一。",
	...
	&"HanBinZhenQi4": {
		...
		"tier": 4,
		"weapon": "心法",
		"description": "回合结束时，若我没有内力，使我翻面。指定：选择对手的一张手牌，使其点数减四并揭示。我翻面后：获得以下效果：回合结束时，我和所有手牌点数减一。",
		"flavor": "左冷禅修炼十余年的至阴至寒功夫，所发寒气远胜冰雪，可将对手全身冻结为冰。",
		"powers": [2, 1, 1, 2],
		"starting_ki": 1,
		"abilities": [
	...
	&"HuJiaDao1": {
		"id": &"HuJiaDao1",
		"glyph": "八方藏刀式",
		"picture": "res://pics/LKT010_537.png",
		"sect": "江湖",
		"tier": 5,
		"weapon": "刀法",
		"description": "对局开始时，揭示我和所有敌方手牌，你获得以下效果：【除非别无选择，对手不能在中央格出牌。双方回合结束时，若此效果的来源牌不在手牌中，失去此效果。】",
	...
	&"HuJiaDao2": {
		"id": &"HuJiaDao2",
		"glyph": "怀中抱月",
		"picture": "res://pics/LKT010_506.png",
		"sect": "江湖",
		"tier": 5,
		"weapon": "刀法",
		"description": "对局开始时，你获得以下效果：【友方被攻击时，揭示此效果的来源牌并使其点数减一，然后抽一张牌。双方回合结束时，若此效果的来源牌不在手牌中，失去此效果。所有友方视为具有以下效果：判断是否能被攻击时，所有点数视为零。被攻击时，将我移除。】",
	...
	&"HuJiaDao3": {
		"id": &"HuJiaDao3",
		"glyph": "闭门铁扇刀",
		"picture": "res://pics/LKT010_499.png",
		"sect": "江湖",
		"tier": 5,
		"weapon": "刀法",
	...
	&"DuGu9Jian2": {
		...
		"tier": 5,
		"weapon": "剑法",
		"description": "进场前，将我移除，抽一张牌，然后额外出一张牌。对手下一张从手牌中打出的牌永久失去效果。",
	...
	&"DuGu9Jian3": {
		...
		"tier": 5,
		"weapon": "剑法",
		"description": "进场前，将我移除，抽一张牌，所有敌方变成点数相同的太祖长拳，然后额外出一张牌。",
	...
	&"FeiTian5": {
		...
		"tier": 5,
		"weapon": "轻功",
		"description": "回合结束时，若手牌或场上有友方刀法，额外出一张牌。",
	...
	&"KuiHua2": {
		...
		"weapon": "轻剑",
		"description": "需自宫。被攻击时，移回手牌。锁定：我攻击时，防御者的点数视为其最小一侧的点数。我攻击后，获得以下效果：敌方攻击时不分敌我。",
