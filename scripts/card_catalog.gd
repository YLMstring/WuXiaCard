...
const _CARD_DEFINITIONS: Dictionary = {
	...
	&"XiXinDaFa4": {
		...
		"tier": 4,
		"weapon": "心法",
		"description": "进场后，使我翻面，并获得以下效果：回合开始时，向你最左侧的手牌以及所有相邻友方吸取一点内力，若没有内力可以吸取，改为吸取点数。判断是否能被攻击时，所有点数视为零。我翻面后，将我的内力依次分配给场上和手牌中能够耗内力的牌，直到我的内力耗尽，然后发起攻击。我攻击时不分敌我。",
	...
	&"XiXinDaFa5": {
		...
		"tier": 5,
		"weapon": "心法",
		"description": "进场后，使我翻面，并获得以下效果：回合开始时，向你最左侧的手牌以及所有相邻友方吸取一点内力，若没有内力可以吸取，改为吸取点数。判断是否能被攻击时，所有点数视为零。我翻面后，将我的内力依次分配给场上和手牌中能够耗内力的牌，直到我的内力耗尽，然后发起攻击。",
	...
	&"TaiJiSanHuan5": {
		...
		"tier": 5,
		"weapon": "剑法",
		"description": "在相邻进场且保持相邻的敌方进场攻击不会选中我的友方，反而会选中我的敌方，敌方攻击敌方后，我失去此效果。指定：选择一个空位，令你首张被移除的牌在此进场，抽一张牌。",
		"flavor": "太极剑法中的招式，神在剑先，绵绵不绝。",
		"powers": [5, 5, 5, 5],
		"starting_ki": 3,
		"abilities": [
	...
	&"TaiJiDaKui5": {
		...
		"tier": 5,
		"weapon": "剑法",
		"description": "在相邻进场且保持相邻的敌方进场攻击不会选中我的友方，反而会选中我的敌方，敌方攻击敌方后，我失去此效果。指定：选择场上的一张敌方牌，令其点数加一，然后所有敌方发起攻击，但攻击时会且只会选中我的敌方。",
