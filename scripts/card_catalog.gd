...
const _CARD_DEFINITIONS: Dictionary = {
	...
	&"HuJiaDao1": {
		...
		"tier": 5,
		"weapon": "刀法",
		"description": "对局开始时，揭示我和所有敌方手牌，你获得以下效果：【除非别无选择，对手不能在中央格出牌。】锁定：我进场前或被丢弃后，你失去上述效果。",
	...
	&"HuJiaDao2": {
		...
		"tier": 5,
		"weapon": "刀法",
		"description": "对局开始时，你获得以下效果：【友方被攻击时，揭示本效果的来源牌并使其点数减一。所有友方视为具有以下效果：判断是否能被攻击时，所有点数视为零。被攻击时，抽一张牌，然后将我移除。】锁定：我进场前或被丢弃后，你失去上述效果。",
	...
	&"HuJiaDao3": {
		...
		"tier": 5,
		"weapon": "刀法",
		"description": "对局开始时，你获得以下效果：【敌方攻击后，揭示本效果的来源牌并使其点数加一，然后若本次攻击未造成翻面，敌方在攻击中使用过的点数变为零。】锁定：我进场前或被丢弃后，你失去上述效果。",
