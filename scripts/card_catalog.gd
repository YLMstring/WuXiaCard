...
const _CARD_DEFINITIONS: Dictionary = {
	...
	&"TiYunZong2": {
		...
		"tier": 2,
		"weapon": "轻功",
		"description": "指定：选择一个其它友方，令其与我依次在彼此的位置重新进场。",
	...
	&"TiYunZong3": {
		...
		"tier": 3,
		"weapon": "轻功",
		"description": "锁定：我翻面前，改为向相邻空格移动。指定：选择一个其它友方，令其与我依次在彼此的位置重新进场。",
		"flavor": "武当派名闻天下的轻功，长于纵跃，在空中轻轻回旋，姿态飘逸。",
		"powers": [1, 3, 1, 3],
		"starting_ki": 1,
		"abilities": [],
	...
	&"TiYunZong4": {
		...
		"tier": 4,
		"weapon": "轻功",
		"description": "每当有牌被移除时，你抽一张牌。锁定：我翻面前，改为向相邻空格移动。指定：选择一个其它友方，令其与我依次在彼此的位置重新进场。",
		"flavor": "武当派名闻天下的轻功，长于纵跃，在空中轻轻回旋，姿态飘逸。",
		"powers": [1, 3, 1, 3],
		"starting_ki": 1,
		"abilities": [],
