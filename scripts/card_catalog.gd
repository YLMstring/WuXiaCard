...
const _CARD_DEFINITIONS: Dictionary = {
	...
	&"XiXinDaFa4": {
		...
		"tier": 4,
		"weapon": "心法",
		"description": "锁定：我攻击时不分敌我。进场后，使我翻面，并获得以下效果：回合开始时，向你最左侧的手牌以及所有相邻友方吸取一点内力，若没有内力可以吸取，改为吸取点数，判断是否能被攻击时，所有点数视为零，我翻面后，手牌和场上的友方增加等同于我内力值的内力，然后我发起攻击。",
	...
	&"XiXinDaFa5": {
		...
		"tier": 5,
		"weapon": "心法",
		"description": "进场后，使我翻面，并获得以下效果：回合开始时，向你最左侧的手牌以及所有相邻友方吸取一点内力，若没有内力可以吸取，改为吸取点数，判断是否能被攻击时，所有点数视为零，我翻面后，手牌和场上的友方增加等同于我内力值的内力，然后我发起攻击。",
