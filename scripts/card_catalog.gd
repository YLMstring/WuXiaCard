...
const _CARD_DEFINITIONS: Dictionary = {
	...
	&"YinYangZhang3": {
		...
		"tier": 3,
		"weapon": "掌法",
		"description": "进场时，将我移除，抽一张牌，手牌中的掌法获得以下效果：我可以攻击直线上相隔一个空位的敌方。发起攻击后，再次发起攻击（不触发本效果）。",
	...
	&"YinYangZhang4": {
		...
		"tier": 4,
		"weapon": "掌法",
		"description": "进场时，将我移除，抽一张牌，手牌中的掌法获得以下效果：我可以攻击直线上相隔一个空位，或相隔一个友方的敌方。发起攻击后，再次发起攻击（不触发本效果）。",
		"flavor": "孝感乐厚的成名功夫，双掌掌力不同，一阴一阳，阳掌先出，阴力却先行着体。",
		"powers": [-1, -1, -1, -1],
