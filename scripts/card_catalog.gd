...
const _CARD_DEFINITIONS: Dictionary = {
	...
	&"TiYunZong4": {
		...
		"tier": 4,
		"weapon": "轻功",
		"description": "每当在你的手牌之外的牌被移除时，你抽一张牌。锁定：我翻面前，改为向首个相邻空格移动。指定：选择一个其它友方，令其与我依次在彼此的位置重新进场，然后耗内力以额外出一张牌。",
		"flavor": "武当派名闻天下的轻功，长于纵跃，在空中轻轻回旋，姿态飘逸。",
		"powers": [1, 3, 1, 3],
		"starting_ki": 1,
		"abilities": [
	...
	&"HuJiaDao1": {
		...
		"tier": 5,
		"weapon": "刀法",
		"description": "对局开始时，揭示我和所有敌方手牌，你获得以下效果：【除非别无选择，对手不能在中央格出牌。回合结束时，若此效果的来源牌不在手牌中，失去此效果。】",
	...
	&"HuJiaDao2": {
		...
		"tier": 5,
		"weapon": "刀法",
		"description": "对局开始时，你获得以下效果：【友方被攻击时，揭示此效果的来源牌并使其点数减一。回合结束时，若此效果的来源牌不在手牌中，失去此效果。所有友方视为具有以下效果：判断是否能被攻击时，所有点数视为零。被攻击时，抽一张牌，然后将我移除。】",
	...
	&"HuJiaDao3": {
		...
		"tier": 5,
		"weapon": "刀法",
		"description": "对局开始时，你获得以下效果：【敌方攻击后，揭示此效果的来源牌并使其点数加一，然后若本次攻击未造成翻面，敌方在攻击中使用过的点数变为零。回合结束时，若此效果的来源牌不在手牌中，失去此效果。】",
