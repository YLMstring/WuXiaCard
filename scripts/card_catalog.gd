...
const _CARD_DEFINITIONS: Dictionary = {
	...
	&"JinYanGong5": {
		...
		"flavor": "全真派至高无上的内功心法，重阳真人传给一灯大师的神功。",
		"powers": [1, 1, 1, 1],
		"abilities": [],
	},
	&"QiXinJuHui1": {
	...
	&"QiXinJuHui3": {
		...
		"tier": 3,
		"weapon": "阵法",
		"description": "我翻面前，若我有相邻友方，耗内力以阻止翻面。友方在任意友方相邻进场时，令其内力加一，并获得以下效果：我翻面前，若我有相邻友方，耗内力以阻止翻面。",
		"flavor": "丘处机等人从天罡北斗阵法中演化出的并力攻敌法门，每一招之出，都将数人劲力集于一点。",
		"powers": [3, 7, 3, 7],
		"starting_ki": 1,
		"abilities": [],
	...
	&"QiXinJuHui4": {
		...
		"tier": 4,
		"weapon": "阵法",
		"description": "锁定：我攻击时，防御者的点数视为其最小一侧的点数。我翻面前，若我有相邻友方，耗内力以阻止翻面。友方在任意友方相邻进场时，令其内力加一，并获得以下效果：我翻面前，若我有相邻友方，耗内力以阻止翻面。",
		"flavor": "丘处机等人从天罡北斗阵法中演化出的并力攻敌法门，每一招之出，都将数人劲力集于一点。",
		"powers": [3, 7, 3, 7],
		"starting_ki": 1,
		"abilities": [],
